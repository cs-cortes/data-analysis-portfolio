...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentages = (rich_country_count / country_count) * 100
    highest_earning_country = highest_earning_country_percentages.idxmax()
    highest_earning_country_percentage = round(highest_earning_country_percentages.max(), 1)
